...
export const matches: Match[] = [
  // Jogo de abertura
  {
    ...
    awayTeam: { code: "CAN", name: "Canadá", flag: "🇨🇦" },
    date: "2026-06-11", time: "18:00", venue: "Estadio Azteca, Cidade do México",
    status: "finished", homeScore: 2, awayScore: 1, group: "Grupo A",
  },
  {
    id: "m2", homeTeam: { code: "USA", name: "Estados Unidos", flag: "🇺🇸" },
    awayTeam: { code: "MAR", name: "Marrocos", flag: "🇲🇦" },
    date: "2026-06-11", time: "21:00", venue: "SoFi Stadium, Los Angeles",
    status: "finished", homeScore: 3, awayScore: 0, group: "Grupo B",
  },
  {
    id: "m3", homeTeam: { code: "BRA", name: "Brasil", flag: "🇧🇷" },
    awayTeam: { code: "NZL", name: "Nova Zelândia", flag: "🇳🇿" },
    date: "2026-06-12", time: "16:00", venue: "MetLife Stadium, Nova York",
    status: "finished", homeScore: 4, awayScore: 0, group: "Grupo E",
  },
  {
    id: "m4", homeTeam: { code: "ARG", name: "Argentina", flag: "🇦🇷" },
    awayTeam: { code: "PER", name: "Peru", flag: "🇵🇪" },
    date: "2026-06-12", time: "19:00", venue: "Hard Rock Stadium, Miami",
    status: "finished", homeScore: 2, awayScore: 0, group: "Grupo D",
  },
  {
    id: "m5", homeTeam: { code: "FRA", name: "França", flag: "🇫🇷" },
    awayTeam: { code: "AUS", name: "Austrália", flag: "🇦🇺" },
    date: "2026-06-12", time: "13:00", venue: "Lincoln Financial Field, Filadélfia",
    status: "finished", homeScore: 3, awayScore: 1, group: "Grupo F",
  },
  {
    id: "m6", homeTeam: { code: "GER", name: "Alemanha", flag: "🇩🇪" },
    awayTeam: { code: "JPN", name: "Japão", flag: "🇯🇵" },
    date: "2026-06-13", time: "16:00", venue: "AT&T Stadium, Dallas",
    status: "finished", homeScore: 1, awayScore: 2, group: "Grupo G",
  },
  {
    id: "m7", homeTeam: { code: "ESP", name: "Espanha", flag: "🇪🇸" },
    awayTeam: { code: "CRC", name: "Costa Rica", flag: "🇨🇷" },
    date: "2026-06-13", time: "19:00", venue: "Mercedes-Benz Stadium, Atlanta",
    status: "finished", homeScore: 5, awayScore: 0, group: "Grupo H",
  },
  {
    id: "m8", homeTeam: { code: "ENG", name: "Inglaterra", flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿" },
    awayTeam: { code: "SEN", name: "Senegal", flag: "🇸🇳" },
    date: "2026-06-13", time: "13:00", venue: "Lumen Field, Seattle",
    status: "finished", homeScore: 3, awayScore: 0, group: "Grupo C",
  },
  {
    id: "m9", homeTeam: { code: "POR", name: "Portugal", flag: "🇵🇹" },
    awayTeam: { code: "URY", name: "Uruguai", flag: "🇺🇾" },
    date: "2026-06-14", time: "16:00", venue: "Gillette Stadium, Boston",
    status: "finished", homeScore: 2, awayScore: 2, group: "Grupo I",
  },
  {
    id: "m10", homeTeam: { code: "BRA", name: "Brasil", flag: "🇧🇷" },
    awayTeam: { code: "COL", name: "Colômbia", flag: "🇨🇴" },
    date: "2026-06-17", time: "19:00", venue: "MetLife Stadium, Nova York",
    status: "finished", homeScore: 1, awayScore: 0, group: "Grupo E",
  },
  {
    id: "m11", homeTeam: { code: "ARG", name: "Argentina", flag: "🇦🇷" },
    awayTeam: { code: "NGR", name: "Nigéria", flag: "🇳🇬" },
    date: "2026-06-18", time: "19:00", venue: "NRG Stadium, Houston",
    status: "upcoming", homeScore: null, awayScore: null, group: "Grupo D",
  },
  {
    id: "m12", homeTeam: { code: "FRA", name: "França", flag: "🇫🇷" },
    awayTeam: { code: "DEN", name: "Dinamarca", flag: "🇩🇰" },
    date: "2026-06-18", time: "16:00", venue: "BMO Field, Toronto",
    status: "upcoming", homeScore: null, awayScore: null, group: "Grupo F",
  },
  {
    id: "m13", homeTeam: { code: "GER", name: "Alemanha", flag: "🇩🇪" },
    awayTeam: { code: "KOR", name: "Coreia do Sul", flag: "🇰🇷" },
    date: "2026-06-19", time: "16:00", venue: "AT&T Stadium, Dallas",
    status: "upcoming", homeScore: null, awayScore: null, group: "Grupo G",
  },
  {
    id: "m14", homeTeam: { code: "USA", name: "Estados Unidos", flag: "🇺🇸" },
    awayTeam: { code: "ENG", name: "Inglaterra", flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿" },
    date: "2026-06-19", time: "21:00", venue: "Rose Bowl, Los Angeles",
    status: "upcoming", homeScore: null, awayScore: null, group: "Grupo B",
  },
  {
    id: "m15", homeTeam: { code: "BRA", name: "Brasil", flag: "🇧🇷" },
    awayTeam: { code: "CMR", name: "Camarões", flag: "🇨🇲" },
    date: "2026-06-20", time: "19:00", venue: "BC Place, Vancouver",
    status: "upcoming", homeScore: null, awayScore: null, group: "Grupo E",
  },
  {
    id: "m16", homeTeam: { code: "ESP", name: "Espanha", flag: "🇪🇸" },
    awayTeam: { code: "MEX", name: "México", flag: "🇲🇽" },
    date: "2026-06-21", time: "18:00", venue: "Estadio Azteca, Cidade do México",
